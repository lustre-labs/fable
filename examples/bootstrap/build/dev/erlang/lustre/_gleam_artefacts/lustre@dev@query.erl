...
-spec find_matching_in_list(
    list(lustre@vdom@vnode:element(VBZ)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(VBZ), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_direct_child(
    lustre@vdom@vnode:element(VBU),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(VBU), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_all_matching_in_list(
    list(lustre@vdom@vnode:element(VDH)),
    selector()
) -> list(lustre@vdom@vnode:element(VDH)).
...
-spec find_all_direct_children(lustre@vdom@vnode:element(VDD), selector()) -> list(lustre@vdom@vnode:element(VDD)).
...
-spec find_all_in_list(list(lustre@vdom@vnode:element(VCY)), 'query'()) -> list(lustre@vdom@vnode:element(VCY)).
...
-spec find_all(lustre@vdom@vnode:element(VCQ), 'query'()) -> list(lustre@vdom@vnode:element(VCQ)).
find_all(Root, Query) ->
    case Query of
        {find_element, Selector} ->
...
-spec find_all_in_children(lustre@vdom@vnode:element(VCU), 'query'()) -> list(lustre@vdom@vnode:element(VCU)).
...
-spec find_all_descendants_in_list(
    list(lustre@vdom@vnode:element(VDQ)),
    selector()
) -> list(lustre@vdom@vnode:element(VDQ)).
...
-spec find_all_descendants(lustre@vdom@vnode:element(VDM), selector()) -> list(lustre@vdom@vnode:element(VDM)).
...
-spec find_in_list(
    list(lustre@vdom@vnode:element(VBO)),
    'query'(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(VBO), lustre@vdom@path:path()}} |
    {error, nil}.
...
?DOC(false).
-spec find_path(
    lustre@vdom@vnode:element(VBE),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(VBE), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_in_children(
    lustre@vdom@vnode:element(VBJ),
    'query'(),
    integer(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(VBJ), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find(lustre@vdom@vnode:element(VAZ), 'query'()) -> {ok,
        lustre@vdom@vnode:element(VAZ)} |
    {error, nil}.
find(Root, Query) ->
...
-spec find_descendant_in_list(
    list(lustre@vdom@vnode:element(VCK)),
    selector(),
    lustre@vdom@path:path(),
    integer()
) -> {ok, {lustre@vdom@vnode:element(VCK), lustre@vdom@path:path()}} |
    {error, nil}.
...
-spec find_descendant(
    lustre@vdom@vnode:element(VCF),
    selector(),
    lustre@vdom@path:path()
) -> {ok, {lustre@vdom@vnode:element(VCF), lustre@vdom@path:path()}} |
    {error, nil}.
