...
-type diff(SZG) :: {diff,
        lustre@vdom@patch:patch(SZG),
        lustre@vdom@events:events(SZG)}.

-type attribute_change(SZH) :: {attribute_change,
        list(lustre@vdom@vattr:attribute(SZH)),
        list(lustre@vdom@vattr:attribute(SZH)),
        lustre@vdom@events:events(SZH)}.
...
-spec diff_attributes(
    ...
    lustre@vdom@events:events(TAI),
    list(lustre@vdom@vattr:attribute(TAI)),
    list(lustre@vdom@vattr:attribute(TAI)),
    list(lustre@vdom@vattr:attribute(TAI)),
    list(lustre@vdom@vattr:attribute(TAI))
) -> attribute_change(TAI).
...
-spec do_diff(
    ...
    lustre@internals@mutable_map:mutable_map(binary(), lustre@vdom@vnode:element(SZN)),
    list(lustre@vdom@vnode:element(SZN)),
    lustre@internals@mutable_map:mutable_map(binary(), lustre@vdom@vnode:element(SZN)),
    ...
    integer(),
    lustre@vdom@path:path(),
    list(lustre@vdom@patch:change(SZN)),
    list(lustre@vdom@patch:patch(SZN)),
    fun((gleam@dynamic:dynamic_()) -> gleam@dynamic:dynamic_()),
    lustre@vdom@events:events(SZN)
) -> diff(SZN).
do_diff(
    Old,
    Old_keyed,
