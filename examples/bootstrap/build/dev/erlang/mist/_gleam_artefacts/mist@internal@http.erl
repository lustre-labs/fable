...
?DOC(false).
-spec add_date_header(gleam@http@response:response(XIA)) -> gleam@http@response:response(XIA).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(XID)) -> gleam@http@response:response(XID).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(XIG)) -> gleam@http@response:response(XIG).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(XIJ)) -> gleam@http@response:response(XIJ).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(XIO)) -> gleam@http@response:response(XIO)).
