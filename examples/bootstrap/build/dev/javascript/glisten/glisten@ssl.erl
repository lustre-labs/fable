...
-file("/home/alex/gleams/glisten/src/glisten/ssl.gleam", 11).
...
-file("/home/alex/gleams/glisten/src/glisten/ssl.gleam", 20).
...
-file("/home/alex/gleams/glisten/src/glisten/ssl.gleam", 26).
-spec accept(glisten@socket:listen_socket()) -> {ok, glisten@socket:socket()} |
    {error, glisten@socket:socket_reason()}.
accept(Socket) ->
    ssl:transport_accept(Socket).

-file("/home/alex/gleams/glisten/src/glisten/ssl.gleam", 29).
...
-file("/home/alex/gleams/glisten/src/glisten/ssl.gleam", 47).
...
-file("/home/alex/gleams/glisten/src/glisten/ssl.gleam", 56).
-spec set_opts(
    glisten@socket:socket(),
...
-file("/home/alex/gleams/glisten/src/glisten/ssl.gleam", 68).
-spec handshake(glisten@socket:socket()) -> {ok, glisten@socket:socket()} |
    {error, nil}.
handshake(Socket) ->
    ssl:handshake(Socket).

-file("/home/alex/gleams/glisten/src/glisten/ssl.gleam", 71).
...
-file("/home/alex/gleams/glisten/src/glisten/ssl.gleam", 81).
...
-file("/home/alex/gleams/glisten/src/glisten/ssl.gleam", 84).
...
-file("/home/alex/gleams/glisten/src/glisten/ssl.gleam", 87).
...
-file("/home/alex/gleams/glisten/src/glisten/ssl.gleam", 90).
