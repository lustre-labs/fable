...
-file("/home/alex/gleams/glisten/src/glisten/tcp.gleam", 11).
...
-file("/home/alex/gleams/glisten/src/glisten/tcp.gleam", 20).
...
-file("/home/alex/gleams/glisten/src/glisten/tcp.gleam", 26).
-spec accept(glisten@socket:listen_socket()) -> {ok, glisten@socket:socket()} |
    {error, glisten@socket:socket_reason()}.
accept(Socket) ->
    gen_tcp:accept(Socket).

-file("/home/alex/gleams/glisten/src/glisten/tcp.gleam", 29).
...
-file("/home/alex/gleams/glisten/src/glisten/tcp.gleam", 50).
...
-file("/home/alex/gleams/glisten/src/glisten/tcp.gleam", 59).
-spec set_opts(
    glisten@socket:socket(),
...
-file("/home/alex/gleams/glisten/src/glisten/tcp.gleam", 68).
...
-file("/home/alex/gleams/glisten/src/glisten/tcp.gleam", 88).
...
-file("/home/alex/gleams/glisten/src/glisten/tcp.gleam", 94).
