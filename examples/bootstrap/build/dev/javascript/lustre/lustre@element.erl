...
-spec fragment(list(lustre@vdom@vnode:element(PIZ))) -> lustre@vdom@vnode:element(PIZ).
fragment(Children) ->
...
-spec map(lustre@vdom@vnode:element(PJK), fun((PJK) -> PJM)) -> lustre@vdom@vnode:element(PJM).
map(Element, F) ->
