...
-type element(OPY) :: {fragment,
        integer(),
        binary(),
        fun((gleam@dynamic:dynamic_()) -> gleam@dynamic:dynamic_()),
        list(element(OPY)),
        lustre@internals@mutable_map:mutable_map(binary(), element(OPY)),
        integer()} |
    {element,
        integer(),
        binary(),
        ...
        binary(),
        binary(),
        list(lustre@vdom@vattr:attribute(OPY)),
        list(element(OPY)),
        lustre@internals@mutable_map:mutable_map(binary(), element(OPY)),
        boolean(),
        boolean()} |
...
-spec fragment(
    ...
    fun((gleam@dynamic:dynamic_()) -> gleam@dynamic:dynamic_()),
    list(element(OPZ)),
    lustre@internals@mutable_map:mutable_map(binary(), element(OPZ)),
    integer()
) -> element(OPZ).
...
-spec element(
    ...
    list(element(OQG)),
    lustre@internals@mutable_map:mutable_map(binary(), element(OQG)),
    boolean(),
    boolean()
) -> element(OQG).
element(
...
-spec element_to_json(
    ...
    binary(),
    binary(),
    list(lustre@vdom@vattr:attribute(ORH)),
    list(element(ORH))
) -> gleam@json:json().
...
-spec set_fragment_key(
    ...
    integer(),
    list(element(OQY)),
    lustre@internals@mutable_map:mutable_map(binary(), element(OQY))
) -> {list(element(OQY)),
    lustre@internals@mutable_map:mutable_map(binary(), element(OQY))}.
...
?DOC(false).
-spec to_keyed(binary(), element(OQY)) -> element(OQY).
to_keyed(Key, Node) ->
    case Node of
