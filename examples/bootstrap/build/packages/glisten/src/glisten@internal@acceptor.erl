...
-type pool(IJR, IJS) :: {pool,
        fun((glisten@internal@handler:loop_message(IJR), IJS, glisten@internal@handler:connection(IJR)) -> gleam@otp@actor:next(glisten@internal@handler:loop_message(IJR), IJS)),
        integer(),
        fun((glisten@internal@handler:connection(IJR)) -> {IJS,
            gleam@option:option(gleam@erlang@process:selector(IJR))}),
        gleam@option:option(fun((IJS) -> nil)),
        glisten@transport:transport()}.
