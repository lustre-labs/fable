...
-type client_message(QZH) :: {mount,
    ...
    {reconcile, integer(), lustre@vdom@patch:patch(QZH)} |
...
?DOC(false).
-spec reconcile(lustre@vdom@patch:patch(QZN)) -> client_message(QZN).
reconcile(Patch) ->
    {reconcile, 1, Patch}.
